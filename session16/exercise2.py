# 1. Quan hệ 1-1 Employee – Device

# Sai: employee_id thiếu unique = True, và device thiếu uselist = False.
# Sửa:
...
# 2. Quan hệ 1-N Department – Employee

# Sai:
# employees = relationship("Employee", back_populates="department_id")
# Nguyên nhân: back_populates phải trỏ đến tên relationship, không phải tên ForeignKey.
# Sửa:
# employees = relationship("Employee", back_populates="department")

# 3. Quan hệ N-N Employee – Project

# Sai: Thiếu secondary = employee_project.
# Sửa:
